...
class Trape(object):
	def __init__(self, stat = 0):
		...
		if self.stat == 1:
			...
			if options.url is None:
				...
				options.url = eval(input(utils.Color['blueBold'] + "-" + utils.Color['white'] + " Enter a URL to generate the lure" + " " + utils.Color['yellow'] + ":~> " + utils.Color['white']))

			if options.port is None:
				options.port = eval(input(utils.Color['blueBold'] + "-" + utils.Color['white'] + " What is your port to generate the server?" + " " + utils.Color['yellow'] + ":~> " + utils.Color['white']))
			...
			if (options.ngrok or (self.ngrok != "")):
				if self.ngrok == '':
					utils.Go("\033[H\033[J")
					self.ngrok = eval(input("What is your nGrok token?" + " " + utils.Color['yellow'] + ":~> " + utils.Color['white']))
				if (self.ngrok != ''):
	...
	def trape_config(self):
		...
		utils.Go("")
		c_nGrokToken = eval(input(utils.Color['blueBold'] + "-" + utils.Color['white'] + " Enter your ngrok token" + " " + utils.Color['yellow'] + ":~> " + utils.Color['white']))
		utils.Go("")
		...
		utils.Go("")
		c_gMapsToken = eval(input(utils.Color['blueBold'] + "-" + utils.Color['white'] + " What is your Google Maps Api Key?" + " " + utils.Color['yellow'] + ":~> " + utils.Color['white']))
		c_gOoglToken = eval(input(utils.Color['blueBold'] + "-" + utils.Color['white'] + " Enter your Goo.gl (shortener) Api Key (leave it empty if you don't have)" + " " + utils.Color['yellow'] + ":~> " + utils.Color['white']))
		utils.Go("")
		...
		utils.Go("")
		c_ipinfo = eval(input(utils.Color['blueBold'] + "-" + utils.Color['white'] + " What is your IP Info Api Key?" + " " + utils.Color['yellow'] + ":~> " + utils.Color['white']))
		utils.Go("")
